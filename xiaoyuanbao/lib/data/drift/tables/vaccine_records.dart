...
class VaccineRecords extends Table {
  ...
  IntColumn get category => intEnum<VaccineCategoryEnum>().withDefault(const Constant(0))();
  IntColumn get status => intEnum<VaccineStatusEnum>().withDefault(const Constant(0))();
...
enum VaccineCategoryEnum { national, optional }
enum VaccineStatusEnum { scheduled, completed, delayed, skipped, contraindicated }
